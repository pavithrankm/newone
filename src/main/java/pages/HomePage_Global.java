...
public class HomePage_Global extends BaseClass {
	...
	@FindBy(xpath="(//a[@class='dckap-redirect-link'])2]") WebElement BrandSelectPopupPCS;
	@FindBy(xpath="(//a[@class='dckap-redirect-link']//img)[1]") WebElement BrandSelectPopupFIS;
	@FindBy(xpath="(//a[@class='dckap-redirect-link'])[3]") WebElement BrandSelectPopupQPS;
	...
	public HomePage_Global clickOnHomeLink() throws Exception
	{
      waitUntilElementVisibility(HomeLink);
		jsClick(HomeLink);
...
//				HomeLink.click();
	...
	public void mouseHoverToShopByCategory() throws Exception
	{
       waitUntilElementVisibility(ShopProducts);
       moveToElement(ShopProducts);
		//		WebDriverWait wait= new WebDriverWait(driver, 20);
...
//		ShopProducts.click();
	...
	{
		moveToElement(ShopProducts);
		moveToElement(FirstLayerCategory);
		moveToElement(SecondLayerCategory);
...
//	{
//		waitUntilElementVisibility(FirstCategory);
////		WebDriverWait wait= new WebDriverWait(driver, 20);
...
////	wait.until(ExpectedConditions.visibilityOf(Locations));
////	Locations.click();
////	 scrollUpandDownUsingElement(HomeLink);
//	 jsClick(Locations);
//	 
//	
...
//{
//
//	String PCS_Username = prop.getProperty("ValidLoginMultiPCS_email");
//	String PCS_Password = prop.getProperty("ValidLoginMultiPCS_Pswd");
//
//	Thread.sleep(5000);
//
//	act = new Actions(driver);
...
//{
//
//	String CPS_Username = prop.getProperty("ValidLoginMultiCPS_email");
//	String CPS_Password = prop.getProperty("ValidLoginMultiCPS_Pswd");
//
//	Thread.sleep(5000);
//
//	act = new Actions(driver);
